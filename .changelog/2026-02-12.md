...
### P3 — Search + Polish
- Full-text search with PostgreSQL tsvector across contacts, companies, signals
- Global search bar in the frontend header
- Activity feed on Dashboard (recent signals + activities combined)
- Company detail page with signals, contacts, deals, score
- Contact enrichment UI (trigger AI enrichment from contact detail)
