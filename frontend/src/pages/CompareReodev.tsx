        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 pb-16 sm:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-6 sm:gap-10">
              ...
              <div className="text-center">
                <div className="text-3xl font-extrabold text-gray-500">$500+</div>
                <div className="text-sm text-gray-500 mt-1">Reo.dev starts at</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 text-center">
              ...
              <div className="text-sm text-gray-500">to get started vs $500+/mo</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl px-8 sm:px-16 py-16 sm:py-20 text-center">
            <div className="absolute inset-0 opacity-10">
              <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern id="grid-compare-reo" width="40" height="40" patternUnits="userSpaceOnUse">
                    <path d="M 40 0 L 0 0 0 40" fill="none" stroke="white" strokeWidth="0.5" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#grid-compare-reo)" />
              </svg>
            </div>

            <div className="relative">
              <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
                Ready for deeper signal intelligence?
              </h2>
              <p className="text-lg text-indigo-100 max-w-xl mx-auto mb-3">
                Go beyond website visitor identification. See the full developer journey
                across 16 signal sources.
              </p>
