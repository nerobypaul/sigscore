-- Repair migration: re-add search_vector generated columns if they don't exist.
-- The original migration (20260212010000) may have been marked as applied without
-- the ALTER TABLE statements actually succeeding on production.
