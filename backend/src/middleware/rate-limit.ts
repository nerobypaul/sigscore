...
/**
 * Demo limiter -- very strict limit for the demo seed endpoint to
 * prevent abuse from seeding large volumes of test data.
 *
 * 3 requests per 1-minute window per IP.
