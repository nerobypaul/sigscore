# Show HN: Sigscore - An AI-first headless CRM built for devtool PLG teams

**URL:** https://sigscore.dev/landing

**Text:**

Hi HN,

I built Sigscore because every CRM I used at devtool companies was designed for
...
Sigscore is an open-source, API-first CRM purpose-built for devtool teams
...
- **SDK-native** — `@sigscore/node` with zero dependencies. Three lines of code
...
Repo: https://github.com/nerobypaul/sigscore
